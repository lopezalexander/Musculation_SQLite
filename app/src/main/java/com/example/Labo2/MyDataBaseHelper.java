...
public class MyDataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //String[] listDonne = [];
        String[][] databaseData = {
                {"Curl Zottman", "avant_bras_curl_zottman.jpg", "x10", "Avant Bras", "3 Set", "5 Minutes", "La position de départ est la même que pour le curl haltères : debout, dos bien droit, genoux légèrement fléchis, deux haltères courtes dans les mains avec une prise en supination. \n\nEn contractant les biceps et en gardant les coudes près du corps, amener les deux haltères en position haute. Une fois dans cette position, faites tourner votre poignet de 180 degrés jusqu'à ce que vous ayez une prise en pronation. Redescendre ensuite les haltères en conservant cette prise. Quand les haltères approchent des cuisses, tournez de nouveau les poignets pour revenir à la position de départ prise en supination.", "30 Secondes", "0"},
                {"Extensions des poignets à la barre", "avant_bras_extensions_des__poignets_la_barre.jpg", "x10", "Avant Bras", "3 Set", "5 Minutes", "Saisissez-vous d'une barre, mains en pronation, c'est-à-dire pouces orientés l'un vers l'autre, et asseyez-vous sur un banc, les avant-bras sur les cuisses. \n\nSinon, agenouillez-vous devant un banc en posant vos avant-bras dessus. Vos mains doivent pendre dans le vide. Levez les mains pour soulever la charge sans bouger les bras ni décoller les coudes du support. Maintenez la contraction pendant au moins une seconde puis, redescendez les mains doucement.", "30 Secondes", "0"},
                {"Extensions des poignets aux haltères", "avant_bras_extensions_des_poignets_aux_halteres.jpg", "x10", "Avant Bras", "3 Set", "5 Minutes", "Empoignez des haltères et asseyez-vous au bout d'un banc, bras sur les cuisses. Vous pouvez également vous agenouiller devant le banc et placez vos bras sur celui-ci. \n\nVos mains doivent être en pronation, c'est-à-dire avec la paume de main en direction du sol. Elles doivent également pendre dans le vide, au bout de votre genou ou du banc, le cas échéant. Levez les mains, pour soulever les haltères vers le haut, sans décoller le coude du support. Seuls les poignets se plient.", "30 Secondes", "0"},
                {"Flexions des poignets avec haltères", "avant_bras_flexions_des_poignets_avec_halteres.jpg", "x10", "Avant Bras", "3 Set", "5 Minutes", "Les flexions des poignets aux haltères se pratiquent de préférence sur un banc, de façon à ce que vos avant-bras ne glissent pas. \n\nSaisissez un haltère dans chaque main (ou dans une seule main si vous choisissez de travailler en unilatéral) et asseyez-vous sur un pupitre ou devant un banc. Vos mains, tournées vers le haut et pouces à l'extérieur, sont suspendues au-dessus du vide, au bord du support. Positionnez-vous légèrement en arrière de façon à ce que vos bras soient relativement tendus.", "30 Secondes", "0"},

                {"Le curl Araignée", "biceps_intro_curl_araignee.jpg", "x10", "Biceps", "3 Set", "5 Minutes", "Se mettre du côté apposé au pupitre. Attrapez la barre, mains en supination. Positionnez vos bras sur le pupitre à 90 degrés. A la force des biceps, amener la barre jusqu'au niveau des épaules puis revenir lentement à la position de départ. \n\nExpirez lors de la contraction et inspirez en revenant à la position bras tendus.", "30 Secondes", "0"},
                {"Curl barre", "biceps_intro_curl_barre.jpg", "x10", "Biceps", "3 Set", "5 Minutes", "En position de départ debout, le dos immobile et droit, les genoux fléchis ou une jambe avancée pour éviter de tricher en s'aidant de l'élan et les coudes prés du corps. Monter et descendre la barre sans à-coups. \n\nVous pouvez varier l'écartement des mains en utilisant une prise large, moyenne ou serrée.", "30 Secondes", "0"},
                {"Curl concentration", "biceps_intro_curl_concentration.jpg", "x10", "Biceps", "3 Set", "5 Minutes", "Assis sur un banc ou une chaise, le dos droit et légèrement penché en avant, le bras perpendiculaire au sol, le coude appuyé sur l'intérieur de la cuisse près du genou et la main en pronation qui tient l'haltère. \n\nMonter la charge avec le biceps sans tricher en se balançant en arrière, et sans bouger les jambes. Terminer le mouvement main en supination (paume des mains vers soi). Il faut travailler un bras après l'autre.", "30 Secondes", "0"},
                {"Le curl Gironda", "biceps_intro_curl_gironda.jpg", "x10", "Biceps", "3 Set", "5 Minutes", "Malgré son nom, le curl Gironda n'est pas vraiment un curl. En effet, on ne réalise pas d'arcs de cercle comme avec un curl barre ; on doit lever la barre verticalement de haut en bas. \n\nPour réaliser l'exercice correctement, il faut tirer la barre à la force des biceps en essayant de la garder contre le buste et bien maintenir les bras en arrière. On utilisera une barre droite en prenant une prise standard de la largeur des épaules.", "30 Secondes", "0"},

                {"Abducteurs assis à la machine (fessiers)", "fessiers_abducteurs_assis_a_la_machine1.jpg", "x10", "Cuisses-Fessiers", "3 Set", "5 Minutes", "Chargez la machine selon vos performances puis asseyez-vous sur son siège. Placez vos pieds sur les repose-pieds et l'extérieur de vos cuisses contre les supports prévus à cet effet. \n\nEnfin, saisissez les poignées qui se trouvent de chaque côté de l'appareil et redressez le torse.", "30 Secondes", "0"},
                {"Adducteurs assis à la machine (intérieur cuisses)", "fessiers_adducteurs_assis_a_la_machine2.jpg", "x10", "Cuisses-Fessiers", "3 Set", "5 Minutes", "Commencez par choisir la charge adaptée à vos performances. Puis, asseyez-vous sur le siège de la machine et placez vos pieds sur les repose-pieds. \n\nLa partie interne de vos cuisses doit toucher le support prévu à cet effet. Enfin, pour finir votre préparation, saisissez les poignées situées de chaque côté de l'appareil et redressez le torse.", "30 Secondes", "0"},
                {"Les fentes", "fessiers_fentes_avec_halt_res.jpg", "x10", "Cuisses-Fessiers", "3 Set", "5 Minutes", "Debout, avancez le pied droit assez loin de sorte qu'en position finale l'angle au niveau du genou droit soit de 90°. Le genou arrière ne touche pas le sol et ne doit pas dépasser l'axe du talon. \n\nPrenez appui sur votre talon et poussez pour revenir à la position de départ. Durant l'exécution du mouvement, regardez en face de vous et conservez le dos bien droit. Soufflez en poussant avec votre jambe. Alternez les cuisses.", "30 Secondes", "0"},
                {"Front Squat", "fessiers_front_squat_barre.jpg", "x10", "Cuisses-Fessiers", "3 Set", "5 Minutes", "Commencez par placer la barre sur un rack à squat et par la charger. Réglez la hauteur de barre un peu plus basse que celle de vos épaules. Puis, approchez-vous de la barre de façon à la coller contre votre cou et placez vos mains soit sous la barre, soit dessus, en croisant les bras. \n\nDécollez la barre du rack et reculez de quelques pas. Positionnez-vous debout, avec les pieds à un écartement de la largeur des épaules. La pointe de vos pieds doit être légèrement pointée vers l'extérieur.", "30 Secondes", "0"},

                {"Tirage nuque", "dos_intro_conseils_musculation.jpg", "x10", "Dos", "3 Set", "5 Minutes", "S'asseoir sur le siège de la machine en mettant les genoux sous les boudins. Tenir la barre en prise large, les mains en pronation. Tirez la barre vers le bas jusqu'à la nuque, puis revenir lentement à la position de départ. Le dos reste toujours droit pendant l'exécution.", "30 Secondes", "0"},
                {"Muscle-Up", "dos_intro_muscle_up.jpg", "x10", "Dos", "3 Set", "5 Minutes", "Le Muscle-up se décompose en 3 parties : la traction, en tirant le corps derrière et non sous la barre ; la transition, où l'on fait passer le corps au dessus de la barre et pour finaliser le mouvement, la répulsion ou dips sur barre fixe. On peut également réaliser l'exercice avec des anneaux de gymnastique, si vous en avez sous la main.", "30 Secondes", "0"},
